...
sudo apt -y install mysql-server-5.7 apache2 php php-xml php-curl php-mysqli php-mbstring git python-dev python-mysqldb python-pycurl libapache2-mod-php build-essential openjdk-8-jdk
