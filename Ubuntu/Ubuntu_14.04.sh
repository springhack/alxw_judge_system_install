...
sudo apt -y install mysql-server-5.5 apache2 php5 php5-curl php5-mysql git python-dev python-mysqldb python-pycurl libapache2-mod-php5 build-essential openjdk-7-jdk
